...
L’objectif est de construire un mini-projet complet permettant de prédire le churn client (résiliation) à partir d’un dataset synthétique généré pour l’étude.
